...
image:https://img.shields.io/jetbrains/plugin/d/org.ideplugins.ci_pipeline_lint[link="https://plugins.jetbrains.com/plugin/19972-ci-pipeline-lint",title="Downloads"]
...
image:https://img.shields.io/jetbrains/plugin/r/stars/org.ideplugins.ci_pipeline_lint[link="https://plugins.jetbrains.com/plugin/19972-ci-pipeline-lint/reviews",title="Ratings"]
image:https://img.shields.io/jetbrains/plugin/v/org.ideplugins.ci_pipeline_lint[link="https://plugins.jetbrains.com/plugin/19972-ci-pipeline-lint",title="Version"]
