...
image:https://img.shields.io/badge/Plugin-Documenation-blue?link=https%3A%2F%2Fplugins.jetbrains.com%2Fplugin%2F19972-gitlab-pipeline-lint%2Fdocs[Static Badge]
...
See the plugin documentation at https://plugins.jetbrains.com/plugin/19972-gitlab-pipeline-lint/docs[Gitlab Pipeline Lint Documentation] on JetBrains
Plugin Marketplace or at https://pablomxnl.gitlab.io/gitlab-yaml-pipeline-lint/starter-topic.html[Gitlab Pages]
