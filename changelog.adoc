...
=== 0.0.21
- Implements https://gitlab.com/pablomxnl/gitlab-yaml-pipeline-lint/-/work_items/8[#8] Autodetect gitlab project ID with gitlab api
...
- Fixes https://gitlab.com/pablomxnl/gitlab-yaml-pipeline-lint/-/issues/17[#17] Event Dispatch Thread (EDT) only error reported by plugin user
