package org.ideplugins.gitlab_pipeline_lint.annotator;
...
import static org.ideplugins.gitlab_pipeline_lint.linter.Constants.GITLAB_RESPONSE_BODY;
...
public class PipelineLintResultsExternalAnnotator extends ExternalAnnotator<PipelineInitialAnnotatorInfo, PipelineLintResult> {
    ...
    private void iterateIssues(PsiFile file, JsonArray messagesArray,
        ...
        Optional.ofNullable(messagesArray).ifPresent(array -> array.forEach(message -> {
